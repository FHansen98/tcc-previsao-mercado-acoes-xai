...
Além disso, seria fundamental adicionar uma avaliação de retorno financeiro para embasar as métricas de acurácia obtidas, calculando retorno acumulado. Isso permitiria verificar se a acurácia direcional obtida se traduz em vantagem operacional efetiva em relação à estratégia de \textit{buy-and-hold}, validando não apenas a capacidade preditiva, mas sua viabilidade financeira. Após validar os novos modelos no S\&P~500, uma próxima etapa seria observar seu comportamento em diferentes índices de mercado, como o IBOVESPA, para avaliar se o modelo consegue identificar padrões em mercados com características distintas.
