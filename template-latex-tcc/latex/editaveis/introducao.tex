...
Apesar do debate sobre a previsibilidade dos mercados, o grande investimento em Aprendizado de Máquina (ML), em particular, o \textit{Deep Learning}, tem aberto novos e promissores estudos para enfrentar este desafio. Os modelos de previsão baseados em ML e Redes Neurais (RN), como as Redes Neurais Recorrentes (RNN) e \textit{Long Short-Term Memory} (LSTM), têm demonstrado a capacidade de capturar padrões e dependências temporais de longo prazo, superando métodos estatísticos tradicionais \cite{Nelson2017UsoRedes}.
