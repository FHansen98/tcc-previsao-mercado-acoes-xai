...
\begin{itemize}
    ...
    \item Implementar modelos xLSTM-TS e Transformer-TS para previsão do valor absoluto, de acordo com modelos de previsão validados, e compara-los ao baseline LSTM em termos de desempenho preditivo e custo computacional.
